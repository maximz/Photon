...
import com.comparty.photon.SpritzFragment;
...
public class Spritzer {
	...
	public void setCallback(SpritzFragment.Callback cb) {
		this.cb = cb;
	}
	...
	private void printWord(String word) {
		...
		if (word.length() == 1) {
			...
			startSpan = CHARS_LEFT_OF_PIVOT+2;
			endSpan = startSpan + 1;
			...
			builder.append(word);
			word = builder.toString();
			startSpan = halfPoint + beginPad + 2;
			endSpan = startSpan + 1;
		} else {
			word = "  " + word;
			startSpan = CHARS_LEFT_OF_PIVOT + 2;
